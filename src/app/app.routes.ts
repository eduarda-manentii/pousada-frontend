...
export const routes: Routes = [
  ...
  { path : "payments/show",          component: ShowPaymentComponent, canActivate: [AuthGuard] },
  { path : "payments/new",           component: NewPaymentComponent, canActivate: [AuthGuard] },
  { path : "payments/edit/:id",      component: NewPaymentComponent, canActivate: [AuthGuard] },
  { path : "payments/index",         component: IndexPaymentComponent, canActivate: [AuthGuard] },
